...
HTTP_CODE=$(curl --output "$TMP" --write '%{http_code}' --silent --show-error  --header "Accept: application/json" --header "Authorization: Bearer $GRAFANA_API_KEY" https://giantswarm.grafana.net/api/dashboards/uid/$1)
